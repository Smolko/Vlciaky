...
class EnduranceRunController extends Controller
{
	/**
	 ...
	 * @return EnduranceRun the loaded model
	 ...
	 * @param EnduranceRun $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='endurance-run-form')
		{
